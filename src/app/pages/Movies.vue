                        ...
                        <div :key="index" class="container__col-sm-6 container__col-md-4 container__col-lg-3 container__col-xl-3">
                            <div class="poster">
                                ...
                                <div class="poster__body">
                                    <h2 class="heading-secondary heading-tertiary--dark">{{ movie.title }}</h2>
                                    <h3 class="heading-tertiary heading-tertiary--light">{{ formatDateToLongDate(movie.release_date) }}</h3>
                                </div>
                            </div>
                        </div>
                    </template>
