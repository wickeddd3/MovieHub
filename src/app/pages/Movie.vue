        ...
        <div class="movie__content">
            <div class="movie__content-item">
                <h1 class="heading-title--sub text-white">
                    {{ movie.title }} ({{ getDateFullYear(movie.release_date) }})
                </h1>
            </div>
            <div class="movie__content-item">
            ...
            <div class="movie__content-item">
                <p class="paragraph text-white">{{ movie.tagline }}</p>
            </div>
            <div class="movie__content-item">
...
export default {
    ...
    methods: {
        fetchMovie() {
            this.$movie.get(`/3/movie/${this.$route.params.movie_id}?language=en-US`)
                .then(res => {
                    this.movie = res.data;
                })
                .catch(err => {
        ...
        fetchMovieVideos() {
            this.$movie.get(`/3/movie/${this.$route.params.movie_id}/videos?language=en-US`)
                .then(res => {
        ...
        recommendedMovies() {
            this.$movie.get(`/3/movie/${this.$route.params.movie_id}/recommendations?language=en-US&page=1`)
                .then(res => {
        ...
        similarMovies() {
            this.$movie.get(`/3/movie/${this.$route.params.movie_id}/similar?language=en-US&page=1`)
                .then(res => {
